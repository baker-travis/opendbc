...
non_tested_cars = [
  ...
  GM.HOLDEN_ASTRA,
  GM.CHEVROLET_MALIBU,
  GM.CHEVROLET_SUBURBAN,  # fingerprints as GMC_YUKON, specs overridden in interface
  HYUNDAI.GENESIS_G90,
...
routes = [
  ...
  # Suburban fingerprints as Yukon (subset CAN messages), specs overridden in interface
  CarTestRoute("83c1c69fbd94f68b/00000000--8c9474264e", GM.GMC_YUKON),
